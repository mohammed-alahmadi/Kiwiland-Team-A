...
public class KiwiCountUI
    ...
    /**
     * Starts GUI for the game menu.
     */
    public void startMenu() {
        getContentPane().removeAll();
        getContentPane().add(new MainMenuUI(this), java.awt.BorderLayout.CENTER);
    ...
    /**
     * Starts GUI for the KiwiIsland game.
     * @param playerName
     */
    ...
    public void gameStateChanged() {
        ...
        if (game.getState() == GameState.LOST) {
            ...
            txtFacts.setText(game.getKiwiFact());
        }
    }
...
//    }
    ...
    private void initComponents() {
        ...
        pnlDialog.setBorder(javax.swing.BorderFactory.createTitledBorder("Dialog"));
        ...
        textPanel.add(pnlDialog, java.awt.BorderLayout.PAGE_START);

        pnlFacts.setBorder(javax.swing.BorderFactory.createTitledBorder("Facts"));
        ...
        textPanel.add(pnlFacts, java.awt.BorderLayout.PAGE_END);

        pnlContent.add(textPanel, java.awt.BorderLayout.PAGE_END);
